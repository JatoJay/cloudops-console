            ...
            {nav.map(({ href, label, icon: Icon }) => {
              ...
              return (
                <Link
                  key={href}
                  href={href}
                  className={`inline-flex min-h-10 items-center gap-2 px-3 text-sm font-bold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-action ${active ? "bg-[#eaf2ff] text-action" : "text-muted hover:bg-white hover:text-ink"}`}
                >
